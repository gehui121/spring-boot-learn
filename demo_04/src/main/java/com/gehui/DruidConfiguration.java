 ...
 * http://localhost:8080/durid/login.html登录url durid/123456
 **/
@Configuration
public class DruidConfiguration {
    ...
    public ServletRegistrationBean statViexServlet() {
        ...
        ServletRegistrationBean servletRegistrationBean =
                new ServletRegistrationBean(new StatViewServlet(), "/durid/*");
        //设置ip白名单
    ...
    public FilterRegistrationBean statFilter(){
        ...
        //忽略过滤的形式
        filterRegistrationBean.addInitParameter("exclusions","*.js,*.gif,*.jpg,*.png,*.css,*.ico,/durid/*");
